...
Figure \ref{fig:acoustic_travellingwave} shows the evolution of the wavefield in time. We notice that there is a reflection of the forward going wave and it meets the the forward going wave at the origin at $t=4.0$. This is a proof of concept that the \ac{ITM} can be used to refocus waves in an acoustic media. 
