...
\section{Time-reversal of S-wave of a velocity impulse point source in an Elastic media} \label{sec:elasticITMswave}
...
in each direction in [4, 8, 16, 32, 64, 128] and calculate the $L^2$ error of the solution with the analytical solution. We calculate this error for different polynomial
