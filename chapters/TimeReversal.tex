...
The first method involves \ac{TRM}s, which rely on 
...
are known inside the entire volume but only for a specific time. By using Loschmidt's demons ~\parencite{Weinert2016}, ~\parencite{Fink2017} the velocity of each particle can be
