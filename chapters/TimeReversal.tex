...
% \begin{equation}
%     \frac{{\left(n \cos\left(c_{0} k \mathit{t_{ITM}}\right) \sin\left(c_{0} k n \tau\right) - n^{2} \sin\left(c_{0} \mathit{t_{ITM}}\right) + \cos\left(c_{0} k n \tau\right) \sin\left(c_{0} k \mathit{t_{ITM}}\right) - \sin\left(c_{0} k \mathit{t_{ITM}}\right)\right)} \cos\left(k x\right) - {\left(n^{2} \cos\left(c_{0} \mathit{t_{ITM}}\right) - n \sin\left(c_{0} k n \tau\right) \sin\left(c_{0} k \mathit{t_{ITM}}\right) - n^{2} + \cos\left(c_{0} k n \tau\right) \cos\left(c_{0} k \mathit{t_{ITM}}\right) - \cos\left(c_{0} k \mathit{t_{ITM}}\right)\right)} \sin\left(k x\right)}{c_{0} k n^{2}}
% \end{equation}
